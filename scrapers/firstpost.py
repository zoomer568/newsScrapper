...
class FirstpostScraper(BaseScraper):
    ...
    def get_home_news(self, include_images=True):
        ...
        try:
            ...
            for article in soup.select('.fp-col-article, .article-item, .news-item, .story-item'):
                link = article.find('a')
                if not link:
                    continue
    ...
    def get_section_news(self, section, include_images=True):
        ...
        try:
            ...
            for article in soup.select('.fp-col-article, .article-item, .news-item'):
                link = article.find('a')
                if not link:
                    continue
